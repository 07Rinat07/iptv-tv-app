...
POLICY = '''package com.iptv.tv.core.p2p
...
POLICY_TEST = '''package com.iptv.tv.core.p2p
...
Path(
    ...
    "AceLiveAdaptiveRequestDepthPolicy.kt"
).write_text(POLICY)
Path(
    "core/p2p/src/test/java/com/iptv/tv/core/p2p/"
    "AceLiveAdaptiveRequestDepthPolicyTest.kt"
).write_text(POLICY_TEST)
...
replace_once(
    "core/p2p/src/main/java/com/iptv/tv/core/p2p/AceLiveActivePeerCoordinator.kt",
    '''    fun schedule(
        nextNeeded: Long,
        head: Long,
        nowMillis: Long
...
replace_once(
    "core/p2p/src/main/java/com/iptv/tv/core/p2p/AceLivePeerSessionCoordinator.kt",
...
replace_once(
    "core/p2p/src/test/java/com/iptv/tv/core/p2p/AceLiveWindowSchedulerTest.kt",
    '''    private fun peer(
''',
    '''    @Test
