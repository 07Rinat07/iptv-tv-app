...
import com.iptv.tv.core.data.repository.VirtualAllChannelsPlaylistRepository
...
abstract class RepositoryBindings {
    ...
    @Binds
    @Singleton
    abstract fun bindPlaylistRepository(impl: VirtualAllChannelsPlaylistRepository): PlaylistRepository
