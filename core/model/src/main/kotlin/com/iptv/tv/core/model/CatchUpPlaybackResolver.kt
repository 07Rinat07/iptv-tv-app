...
data class CatchUpPlaybackResolution(
 ...
 *
 * The resolver lives in core:model so EPG and Player features can share one fail-closed contract
 * without depending on core:data implementation details.
 */
object CatchUpPlaybackResolver {
