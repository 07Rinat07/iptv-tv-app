...
- Каталог логотипов уже вынесен в локальный asset logo pack, parser готов к внешним JSON pack-ам, а редактор умеет применять внешний JSON pack к текущему плейлисту, загружать сетевой logo pack с cache fallback, вручную править metadata override для страны/языка/категории и массово применять metadata к выбранным каналам; более продвинутый metadata manager ещё в работе.
