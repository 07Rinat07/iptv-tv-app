...
- редактор каналов и безопасные рабочие копии с общей TV-постраничной прокруткой, включая PageUp/PageDown и ChannelUp/ChannelDown;
- Media3/ExoPlayer с изолированным LibVLC fallback;
- Ace Stream Android Service/AIDL;
- группы, подгруппы, избранное, история и EPG;
- управление D-pad, пультом, мышью, тачпадом и сенсорным экраном; меню «Разделы» получает явный стартовый TV-focus и возвращает его на кнопку открытия после перехода/закрытия;
- карточки и группы действий с общим TV-focus при получении фокуса запрашивают прокрутку в видимую область;
