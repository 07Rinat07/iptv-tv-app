...
3. `Recording/Timeshift`: запись текущего эфира, запись по EPG, расписания, включение/выключение расписаний, выбор app-specific папки записей, статусы, автоочистка старых файлов и storage-aware лимиты вместо жёсткого `15 минут / 256 MB`.
