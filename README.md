...
- Каталог логотипов уже вынесен в локальный asset logo pack, а parser готов к внешним JSON pack-ам; сетевой cache, UI-загрузка внешних pack-ов и полноценный ручной менеджер метаданных ещё в работе.
...
8. `Logo/Metadata Resolver`: общий resolver, локальный asset logo pack, import-ready parser внешних JSON logo pack-ов и подбор по `tvg-id`, имени, стране, языку и домену источника уже доступны; дальше нужны сетевой cache, UI-импорт внешних logo pack-ов и полноценный ручной менеджер метаданных.
