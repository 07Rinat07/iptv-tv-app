...
2. `Provider Accounts`: сохранение и синхронизация `Xtream Codes`/`Stalker Portal` уже доступны в MVP; дальше нужны адаптеры `Jellyfin/Plex/Tvheadend/HdHomeRun`, проверка статуса аккаунта и безопасное хранение секретов.
