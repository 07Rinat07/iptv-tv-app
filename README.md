...
- Каталог логотипов уже вынесен в локальный asset logo pack; сетевой cache, загрузка внешних pack-ов и полноценный ручной менеджер метаданных ещё в работе.
...
8. `Logo/Metadata Resolver`: общий resolver, локальный asset logo pack и подбор по `tvg-id`, имени, стране, языку и домену источника уже доступны; дальше нужны сетевой cache, импорт внешних logo pack-ов и полноценный ручной менеджер метаданных.
