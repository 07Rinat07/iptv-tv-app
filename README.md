...
- Каталог логотипов уже вынесен в локальный asset logo pack, parser готов к внешним JSON pack-ам, а редактор умеет применять внешний JSON pack к текущему плейлисту, загружать сетевой logo pack с cache fallback, вручную править metadata override для страны/языка/категории, массово применять metadata к выбранным каналам, быстро выбирать видимые/безлоготипные каналы и применять текстовые metadata rules к выбранным/видимым каналам; более визуальный конструктор правил metadata manager ещё в работе.
