        ...
        item {
            Card(modifier = Modifier.fillMaxWidth().tvFocusOutline()) {
                Column(
                    ...
                    Text("Справка: каталог и Избранное", style = MaterialTheme.typography.titleMedium)
                    Text("1. В «Мои плейлисты» выберите обычный список или системное «Избранное» и нажмите «Открыть каталог».")
                    ...
                    Text("13. Для выбранного favorite нажмите «Источники», чтобы увидеть известные варианты с provenance, live/saved состоянием и health без показа stream URL или учетных данных.")
                    Text("14. Кнопка «Использовать» делает вариант предпочтительным; остальные source variants сохраняются и остаются доступными для последующего выбора.")
                }
            }
        }
        item {
